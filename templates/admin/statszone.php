...
echo "&plantype=";
echo $plantype;
echo "&type=zone\"    title=\"点击查询后再导出\" ><img src=\"/templates/";
echo Z_TPL;
...
echo $searchval != "" ? $searchval : "广告位ID";
...
foreach ( ( array )$stats as $s )
{
		...
		echo $s['day'];
		echo "</td>\r\n                           <td colspan=\"11\"><span style=\"display:none\" id=\"s_";
		echo $s['zoneid'].$s['day'];
		echo "\"><a href=\"do.php?action=statsads&actiontype=search&timerange=";
		echo $s['day'];
		echo "/";
		echo $s['day'];
		echo "&searchval=";
		echo $s['zoneid'];
		echo "&searchtype=4\">投放广告</a>&nbsp;|&nbsp;<a href=\"do.php?action=adsip&timerange=";
		echo $s['day'];
		echo "&actiontype=search&searchval=";
		echo $s['zoneid'];
		echo "&searchtype=5\">访客IP</a>&nbsp;|&nbsp;<a href=\"do.php?action=trend&actiontype=dayadnweek&searchtype=5&searchval=";
		echo $s['zoneid'];
		echo "&timerange=";
		echo $s['day']."/".$s['day'];
		...
		echo $s['day'];
		echo "]&nbsp;24小时走势图</a> &nbsp;|&nbsp;<a href=\"do.php?action=trend&actiontype=dayadnweek&searchtype=5&searchval=";
		echo $s['zoneid'];
		echo "&timerange=w&TB_iframe=true&height=300&width=700\"  title=\"“#";
		echo $s['zoneid']."";
		echo "”的最近一星期走势图\"   class=\"thickbox\" >最近一星期走势图</a>  </span>&nbsp;</span> </td>\r\n                           <td  class=\"td_b_5\">&nbsp;</td>\r\n                        </tr>\r\n\t\t\t\t\t\t \r\n\t\t\t\t\t\t\r\n\t\t\t\t\t\t ";
		$sumnum += $s['num'];
		$sumviews += $s['views'];
		$sumclicks += $s['clicks'];
