...
foreach ( ( array )$plan as $p )
{
		...
		else if ( $p['status'] == "0" ||$p['status'] == "5" )
		{
				echo "<font color=\"red\">待审（修改待审）</font>";
		}
		else if ( $p['status'] == "1" )
		{
		...
		echo $p['planid'];
		echo "\"><a href=\"do.php?action=editplan&planid=";
		echo $p['planid'];
		echo "\" title=\"编辑这个计划“";
		echo $p['planname'];
		echo "”\">编辑</a> | ";
