...
<div class="main">
  <div class="left">
    ...
    <ul>
      ...
      <li><span>账户余额：</span><strong><?php echo round($u["money"],2);?></strong>元    &nbsp;&nbsp; </li>
<!--        <img  src='/templates/--><?php //echo Z_TPL?><!--/images/add.gif' align='absmiddle' /> <a href="?action=consumelist&actiontype=charge&TB_iframe=true&height=220&width=600"  title="请选择充值网关"   class="thickbox">马上充值&raquo;</a>-->
