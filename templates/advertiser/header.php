...
<table width="910" height="72" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="230"><img src="/templates/<?php echo Z_TPL?>/images/logo.png"   border="0" /></td>
...
<!--<li --><?php //if(in_array($_GET['action'],array('audit'))) echo "class='current1'"?>
<!--\><a href="?action=audit">审核申请</a></li>-->
<?php //if($this->cpa_cps) { ?>
<!--    <li --><?php //if(in_array($_GET['action'],array( 'order')))  echo "class='current1'"?>
<!--    ><a href="?action=order">查看订单</a></li>-->
<?php //}?>
<!--<li --><?php //if($_GET['action'] == 'consumelist') echo "class='current1'"?>
<!--\><a href="?action=consumelist">在线充值</a></li>-->