...
include TPL_DIR . "/header.php"; ?>
    <div id="pro_menu" class="pro_menu"
         stylea="height: 11px; display: block;background-color:#FFFFFF;background-position:0 -107px;">
        <div class="shell">
            <ul class="pro">
...
<!--        <img  src='/templates/-->
				<?php //echo Z_TPL?><!--/images/add.gif' align='absmiddle' /> <a href="?action=createads">新建广告&raquo;</a>-->
    </span></h2>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="wrap tb0"
			...
			foreach ((array)$ads as $a) {
                ...
                <tr id="tbList">
                    ...
                    <td align="center"><a
                                href="?action=editads&planid=<?php echo $a['planid'] ?>&adsid=<?php echo $a['adsid'] ?>&adstypeid=<?php echo $a['adstypeid'] ?>">编辑</a>
                    </td>
