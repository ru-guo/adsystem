...
<tr>
  ...
  <tr>
    <td  colspan="2" class="reg_t14b">正在注册会员...（注意：用户名不能使用中文） 如果已有账号！<a href="?action=login">点击登录</a></td>
   </tr>
  <tr>
    <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">用户账号： </td>
    <td bgcolor="#E7F0F5"><input name="username" type="text"  class="reg_input" id="username" /> <span class="required">*</span>(必填)<span id="usernameTip"></span></td>
  </tr>
  <tr>
    <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">用户密码： </td>
    <td bgcolor="#E7F0F5"><input name="password" type="password" class="reg_input" id="password"/> <span class="required">*</span>(必填)<span id="passwordTip"></span></td>
  </tr>
  <tr>
    <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">密码确认：</td>
    <td bgcolor="#E7F0F5"><input name="passwordre" type="password" class="reg_input" id="passwordre"/> <span class="required">*</span>(必填)<span id="passwordreTip"></span></td>
  </tr>
   <tr>
     <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">安全问题：</td>
     <td bgcolor="#E7F0F5"><input id="question" type="text" value="" name="question"  class="reg_input"/>  <span class="required">*</span>(必填)<span id="questionTip"></span></td>
   </tr>
   <tr>
     <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">问题答案：</td>
     <td bgcolor="#E7F0F5"><input id="answer" type="text" value="" name="answer" class="reg_input"/>  <span class="required">*</span>(必填)<span id="answerTip"></span> </td>
   </tr>
   <tr>
     <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">联系名字：</td>
    <td bgcolor="#E7F0F5"><input id="contact" type="text" value="" name="contact" class="reg_input" /> <span class="required">*</span>(必填) <span id="contactTip"></span></td>
  </tr>
  <!---<tr>
    <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">固定电话：</td>
    <td bgcolor="#E7F0F5"><input id="tel" type="text" value="" name="tel" class="reg_input"/><span id="telTip"></span></td>
  </tr>
  <tr>
    <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">手机号码：</td>
    <td bgcolor="#E7F0F5"><input id="mobile" type="text" value="" name="mobile" class="reg_input" /><span id="mobileTip"></span></td>
  </tr>--->
  <tr>
    <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">联系 Q Q：</td>
    <td bgcolor="#E7F0F5"><input name="qq" type="text" class="reg_input" id="qq"/> <span class="required">*</span>(必填)<span id="qqTip"></span></td>
  </tr>
  <tr>
    <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">邮箱地址：</td>
    <td bgcolor="#E7F0F5"><input name="email" type="text" class="reg_input" id="email"/> <span class="required">*</span>(必填)<span id="emailTip"></span></td>
   </tr>
  <tr id="bank1">
    <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">银行名称：</td>
    <td bgcolor="#E7F0F5"><select name="bank" id="bank" style="width:160px;" onchange="Dobank()">
      <?php  foreach ($GLOBALS['C_Bank'] as $bank=>$val){?>
      <?php if($val[1]) {?>
      <option value="<?php echo $val[0]?>"><?php echo $bank?></option>
      <?php }?>
      <?php }?>
    </select>   <span class="required">*</span>(必填)<span id="bank"></span> </td>
  </tr>
  <tr id="bank2">
    <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">收款姓名：</td>
    <td bgcolor="#E7F0F5"><input name="accountname" type="text" class="reg_input" id="accountname"/> <span class="required">*</span>(必填)<span id="accountnameTip"></span></td>
  </tr>
  <tr id="bank3">
    <td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">开户地址：</td>
    <td bgcolor="#E7F0F5"><input name="bankname" type="text" class="reg_input" id="bankname"/>
        <span id="banknameTip"></span></td>
  </tr>
  <tr id="bank4">
    <<td height="35" align="right" bgcolor="#E7F0F5" class="reg_tit">收款帐号：</td>
    <td bgcolor="#E7F0F5"><input name="bankacc" type="text" class="reg_input" id="bankacc" /> <span class="required">*</span>(必填) <span id="bankaccTip"></span></td>
  </tr>
  <tr id="d_service">
