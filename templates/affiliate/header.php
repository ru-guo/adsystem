...
<div class="header_menu">
  <div class="shell">
    <ul class="clear" id="channel">
      ...
      <li <?php if(in_array($_GET['action'],array('planlist','planads','adslist','createzt'))) echo "class='current1'"?>><a href="index.php?action=planlist">推广链接</a></li>
      <li <?php if(in_array($_GET['action'],array('createsite','zonelist','sitelist','editsite','zone','getcode'))) echo "class='current1'"?>><a href="index.php?action=sitelist">管理网站</a></li>
      <li <?php if(in_array($_GET['action'],array('stats' )))  echo "class='current1'"?>><a href="index.php?action=stats">数据报表</a></li>
<!--	  --><?php //if($this->cpa_cps) { ?>
<!--	  <li --><?php //if(in_array($_GET['action'],array( 'order')))  echo "class='current1'"?>
<!--      >-->
<!--          <a href="index.php?action=order">查看订单</a>-->
<!--      </li>-->
<!--	   --><?php //}?>
      <li <?php if($_GET['action'] == 'paylist') echo "class='current1'"?>><a href="index.php?action=paylist">支付结算</a></li>
      <li <?php if($_GET['action'] == 'userinfo') echo "class='current1'"?>><a href="index.php?action=userinfo">流量主信息</a></li>
