...
<div id="pro_menu" class="pro_menu" stylea="height: 11px; display: block;background-color:#FFFFFF;background-position:0 -107px;">
  <div class="shell">
    <ul class="pro">
      ...
      <li ><a href="?action=adslist">推广链接</a></li>
...
<div class="main">
  <div class="left">
    ...
    <ul>
      ...
      <li><span>未结算款包括：</span>日结款<strong><?php echo $u["daymoney"];?></strong>元 周结款<strong><?php echo $u["weekmoney"];?></strong>元 月结款<strong><?php echo $u["monthmoney"];?></strong>元
