...
$w = (int)$_GET['w'];
$h = (int)$_GET['h'];
$html = '<iframe src="http://www.zylm.com/page/?s='.$s.'&loc=\'+_Zloc+\'&ref=\'+_Zref+\'&zhv=\'+_Zhv_()+\'"  width="'.$w.'" height="'.$h.'" frameborder="0" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no"></iframe>';
