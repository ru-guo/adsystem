...
echo $action;
echo "&actiontype=add&TB_iframe=true&height=100&width=300\"  title=\"新建分类\" class=\"thickbox\"><img  src='/templates/";
echo Z_TPL;
echo "/images/add.gif' align='absmiddle' /> <strong>新建分类</strong></a></li>\r\n                          <li>|</li>\r\n                          <li><a href=\"do.php?action=";
echo $action;
echo "\" ";
if ( $top == "" )
{
...
foreach ( ( array )$sitetype as $s )
{
		...
		echo $s['sid'];
		echo "&TB_iframe=true&height=100&width=300\" title=\"修改分类信息\" class=\"thickbox\">修改</a></td>\r\n                        <td width=\"6\" class=\"td_b_5\">&nbsp;</td>\r\n                      </tr>\r\n                      ";
}
