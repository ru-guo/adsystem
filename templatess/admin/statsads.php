...
echo "&plantype=";
echo $plantype;
echo "&type=ads\"    title=\"点击查询后再导出\" ><img src=\"/templates/";
echo Z_TPL;
...
foreach ( ( array )$stats as $s )
{
		...
		$a = $adsmodel->getadsrowid( $s['adsid'] );
		...
		echo "\t\t\t\t\t\t    <br/>";
		echo $at['name'];
		echo "</a></td>\r\n                          <td><strong><a href=\"do.php?action=plan&&actiontype=search&searchval=";
		echo $s['planid'];
		echo "&searchtype=2\">";
		...
		echo $s['adsid'].$s['day'];
		echo "\"><a href=\"do.php?action=statszone&actiontype=search&timerange=";
		echo $s['day'];
		echo "/";
		echo $s['day'];
		echo "&searchval=";
		echo $s['adsid'];
		echo "&searchtype=4\">投放广告位</a>&nbsp;|&nbsp;<a href=\"do.php?action=adsip&timerange=";
		echo $s['day'];
		echo "&actiontype=search&searchval=";
		echo $s['adsid'];
		echo "&searchtype=3\">访客IP</a>&nbsp;|&nbsp;<a href=\"do.php?action=trend&actiontype=dayadnweek&searchtype=3&searchval=";
		echo $s['adsid'];
		echo "&timerange=";
		echo $s['day']."/".$s['day'];
		...
		echo $s['day'];
		echo "]&nbsp;24小时走势图</a> &nbsp;|&nbsp;<a href=\"do.php?action=trend&actiontype=dayadnweek&searchtype=3&searchval=";
		echo $s['adsid'];
