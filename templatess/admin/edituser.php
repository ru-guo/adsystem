...
echo "<script>function checkform(frm){ var advprice = parseFloat(frm.advprice.value); if (advprice>0.006) { alert(\"网站主的单价不能大于0.006\"); frm.advprice.focus(); return false;} }</script>                  <form action=\"do.php?action=";
echo $action;
