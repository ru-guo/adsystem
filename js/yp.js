...
var $dom={
		...
		c : function (){
			...
			if(yP_fileext!='.swf'){
				...
				yP_C_zy_str="<table width='"+(this.adw+4)+"' height='"+(this.adh+4)+"' border='0'cellpadding='0' cellspacing='0' style=' border:0px solid #ffffff'><tr><td height='0' bgcolor='#ffffff'><div  style='background-image: url("+yP_imgServer+"/images/copy.png);*background-image:none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src="+yP_imgServer+"/images/copy.png);background-repeat:no-repeat;position:absolute;top:1px;height:16px;width:90px;'><a href='http://"+yP_unionUrl+"' target='_blank' style='height:16px;width:90px;display:block;'></a></div></td></tr><tr><td>"+this.stra+"</td></tr></table>";
			}else {
				if(yP_planType=='cpv') {
				...
				yP_C_zy_str="<table width='"+(this.adw+4)+"' height='"+(this.adh+4)+"' border='0' cellpadding='0' cellspacing='0' style=' border:0px solid #ffffff'><tr><td height='6' bgcolor='#ffffff'><div  style='background-image: url("+yP_imgServer+"/images/copy.png);*background-image:none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src="+yP_imgServer+"/images/copy.png);background-repeat:no-repeat;height:16px;width:90px;'><a href='http://"+yP_unionUrl+"' target='_blank' style='height:16px;width:90px;display:block;'></a></div></td></tr><tr><td>"+this.stra+"<div style='cursor:pointer;z-index:100000;position:absolute;height:"+this.adh+"px;width:"+this.adw+"px;background-color:#fff;opacity:0.01;filter:alpha(opacity:1);'></div></a><div style=' z-index:9999;cursor:pointer;text-align:center' >"+dL_flash+"</div></td></tr></table>";
			}
			this.popup.innerHTML='<span style="position:absolute;top:-1px;right:10px;cursor:pointer;;z-index:111;font-size:16px;color:#ffffff" onclick="$dom.hi()">x</span>'+yP_C_zy_str+'';	
			s.display="none";
